...
export const GenerateIcon: React.FC<{ className?: string }> = (props) => (
...
export const FavoritesIcon: React.FC<{ className?: string }> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
...
export const StarFilledIcon: React.FC<{ className?: string }> = (props) => (
