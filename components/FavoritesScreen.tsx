...
const FavoritesScreen: React.FC<FavoritesScreenProps> = ({ ads, toggleFavorite }) => {
  if (ads.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center h-full text-center text-text-secondary dark:text-dark-text-secondary p-8">
        <FavoritesIcon className="w-16 h-16 mb-4" />
        <h2 className="text-xl font-bold text-text-primary dark:text-dark-text-primary">No Favorites</h2>
